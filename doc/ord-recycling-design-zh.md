...
年（约 585 万年）才溢出（2⁶⁴ ÷ 10⁵ ≈ 1.84 × 10¹⁴ 秒；远超宇宙年龄）——这点没有任何
现实工作负载能突破。所以「ord 会不会耗尽」
...
**不需要。** ord 是 `std::uint64_t`。每秒 10⁵ 个 ord → 约 5.8 × 10⁶ 年（约 585 万年）
才耗尽（2⁶⁴ ÷ 10⁵ ≈ 1.84 × 10¹⁴ 秒）。即使 32-bit ord 也只够约 11.9 小时连续写入
（2³² ÷ 10⁵ ≈ 4.3 × 10⁴ 秒）。ord 回收**不是**为了防止空间耗尽。
